      ...
      <template v-for="(item, i) in items">
        ...
        >
          ...
          <v-list-item v-for="(child, i) in item.children" :key="i" :to="child.link" link>
            ...
            <v-list-item-content>
              <v-list-item-title class="grey--text">{{ child.title }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list-group>
        <v-list-item
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title class="grey--text" link>{{ item.title }}</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </template>
    </v-list>
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: "CloseBuy", icon: "mdi-circle-small", link: "/close-buy" }
          ]
        },
        { divider: true },
        { heading: "PROJECTS" },
