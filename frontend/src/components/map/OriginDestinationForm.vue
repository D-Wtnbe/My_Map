      ...
      <div class="two fields">
        <div class="field">
          <div class="ui left icon input">
            ...
            <input type="text" placeholder="出発場所" ref="origin" />
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
            <i class="flag checkered icon"></i>
            <input type="text" placeholder="到着場所" ref="destination" />
          </div>
        </div>
        <button
...
export default {
  ...
  methods: {
    calculateButtonPressed() {
      ...
      const URL = `https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/distancematrix/json?origins=${this.route.origin.lat},${this.route.origin.lng}&destinations=${this.route.destination.lat},${this.route.destination.lng}&key=${this.apiKey}`;
